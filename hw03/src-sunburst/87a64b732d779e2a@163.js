...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>參與者中，超過35% 為工作室的藝術工作者，顯示藝術領域對於環保議題的關注。</li>
<li>大多數藝術工作者選擇以減少包裝的方式來降低碳排放量。</li>
<li>美術館的藝術工作者不僅注重減少包裝，還更加關注節約工作場所的能源，但在使用再生材料方面排名較低。</li>
<li>不同族群的參與者都對於減少包裝、使用再生材料以及節約能源表現出高度關注。</li>
<li>藝術領域的專業從業者呈現出對環保行動有著共同的價值觀和實踐。</li>
<li>這種共同的環保態度可能為整個藝術行業提供可持續發展的方向。</li>
  </ul>
</h3>`
)}
